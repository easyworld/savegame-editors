...
Item.buildHtmlElements=function(item){
	...
	if(item.category==='food'){
		var foodEffects=[
			...
			{name:'回复精力', value:Item.FOOD_EFFECT_STAMINA_RECOVER},
			{name:'额外心心', value:Item.FOOD_EFFECT_LIFE_MAX_EXTRA},
			{name:'额外精力', value:Item.FOOD_EFFECT_STAMINA_MAX_EXTRA},
			...
			{name:'移动力提升', value:Item.FOOD_EFFECT_SPEED_PLUS},
			...
			{name:'瘴气侵蚀恢复', value:Item.FOOD_EFFECT_LIFE_GLOOM_RECOVERY},
			{name:'瘴气防护提升', value:Item.FOOD_EFFECT_MIASMA_GUARD},
